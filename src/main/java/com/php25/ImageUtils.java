...
public class ImageUtils {
     ...
     * @return
     * @see com.php25.ImageUtils#getInputStreamFromUrl(String, int, boolean)
     */
     ...
     * @param readTimeOutMillis
     * @return
     * @see com.php25.ImageUtils#getDrawableFromUrl(String, int, boolean)
     */
     ...
     * @param readTimeOut
     * @return
     * @see com.php25.ImageUtils#getBitmapFromUrl(String, int, boolean)
     */
